...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiBookOpen, FiImage } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'blog-writer'];
  ...
  const { data, error, isLoading } = useSWR<GalleryInterface[]>(
    ...
    () => getGalleries({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Artwork', path: '/artworks', entity: 'artwork', service: AccessServiceEnum.PROJECT, icon: FiBox },
